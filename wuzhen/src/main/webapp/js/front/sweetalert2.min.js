!function (e, t) {
    ...
    function e() {
        ...
        return new Promise(function (r) {
            ...
            var p, f = function (n) {
                ...
                var a = n || window.event, l = a.target || a.srcElement, c = h(l, i.confirm), d = h(l, i.cancel),
                    p = h(o, "visible");
                switch (a.type) {
                    case"mouseover":
                    case"mouseup":
                    ...
                    case"click":
                        ...
                        } else f(!0); else d && p && (t.closeModal(), r(!1))
                }
            ...
            d.previousDocumentClick = document.onclick, document.onclick = function (n) {
                var o = n || window.event, a = o.target || o.srcElement;
            ...
            switch (e.input) {
                ...
                case"radio":
                    ...
                    j.innerHTML = "", H = function (t) {
                        for (var n in t) {
                            var o = 1, r = document.createElement("input"), a = document.createElement("label"),
                    ...
                    break;
                case"checkbox":
                    var K = C(o, i.checkbox), W = o.querySelector("#" + i.checkbox);
    ...
    var n = "swal2-", o = function (e) {
        ...
        r = o(["success", "warning", "info", "question", "error"]), a = {
            title: "",
            text: "",
            html: "",
            type: null,
        ...
        d = {previousDocumentClick: null, previousWindowKeyDown: null, previousActiveElement: null}, p = function (e) {
            ...
            var t = e.clientHeight, n = parseInt(getComputedStyle(e).getPropertyValue("padding-top"), 10);
            ...
            var s = n.querySelector("h2"), d = n.querySelector("." + i.content), p = y(), m = v(),
                h = n.querySelector("." + i.spacer), g = n.querySelector("." + i.close);
    ...
    return t.queue = function (e) {
        ...
        if (!document.getElementsByClassName(i.container).length) {
            ...
            var n = f(), o = C(n, i.input), r = C(n, i.select), a = n.querySelector("#" + i.checkbox),
                c = C(n, i.textarea);
            o.oninput = function () {
