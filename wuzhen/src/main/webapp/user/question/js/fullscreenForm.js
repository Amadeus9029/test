...
;( function( window ) {
	...
	FForm.prototype._init = function() {
		...
		console.log(this.el.querySelector( 'form' ))
		...
		this.current = 0;
		// all fields
		this.fields = Array.from( this.fieldsList.children );
		// total fields
	...
	FForm.prototype._addControls = function() {
		...
		this.ctrlContinue = createElement( 'button', { cName : 'fs-continue', inner : '下一步', appendTo : this.ctrls } );
